...
author: Richard MacManus (interview with Fred Schott)
...
*[Image: How Flue evolved via React-style hooks; diagram by Richard MacManus]*
...
*[Embedded tweet: Fred Schott (@FredKSchott), "is this real life?" — 10:05 PM · Jun 17, 2026]*
...
*Capture note (not part of the source): fetched in full from a logged-in browser session; this piece was readable without a paywall interruption. Diagram and embedded tweet noted inline rather than transcribed.*
