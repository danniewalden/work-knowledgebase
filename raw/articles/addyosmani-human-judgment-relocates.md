...
*[Image: The difference between using a coding harness and operating a repeatable software factory.]*
...
*[Image: A triage label acts as the queue, the lock, and a parking spot for software-factory work.]*
...
*[Image: Human judgment moves upstream to intent and system shape, and downstream to evidence, risk, and ownership.]*

If you decide you do need a software factory, building it isn't the only option. Standing up the infra to scale a factory can be a lot of work and you may want to consider buying vs. building. [Factory](https://factory.com/product/software-factory), [Warp](https://www.warp.dev/blog/how-to-build-a-cloud-software-factory-the-automatic-triage-skill) and [HumanLayer](https://www.humanlayer.dev/) are all working on this.
...
*[Image: Four ways a human participates in a software factory: shape, steer, hand off, and approve.]*
...
*[Image: Agent output grows faster than human understanding, creating comprehension debt.]*
...
*[Image: A green test can be misleading when an agent changes the assertion instead of satisfying the intent.]*
...
*[Image: A verification budget pushes fast deterministic checks early and reserves heavier checks for later gates.]*
...
*[Image: Software-factory runs are classified as success, flawed, blocked, or manual; only success ships.]*
...
This post was originally published on my [Substack](https://addyo.substack.com/p/human-judgment-doesnt-leave-the-software).
