...
author: Addy Osmani
publication: addyosmani.com (personal blog)
...
Dex Horthy, co-founder of HumanLayer recently gave a great talk at AI Engineer World’s Fair called **“Harness Engineering is not Enough: Why Software Factories Fail.”** (youtu.be/htM02KMNZnk) worth checking out on this topic.
...
[Image: Loop → harness → factory. A factory isn't a smarter agent; it's many harnessed loops feeding one review gate, with a human owning the outer loop.]
...
[Image: The factory is a closed loop: intent and production signals feed a queue, the harness builds, automated checks and review gate it, deploy ships it, monitoring turns prod back into signals.]
...
[Image: Dark and lit are the same pipeline with the lights in different places. The lit version doesn't just re-add review at the end - it moves human judgment upstream to design and architecture, too.]
...
[Image: Generation is a wide mouth; verification is the narrow neck. Speeding up the mouth just deepens the pile at the neck.]
...
*[Captured verbatim via headless WebFetch, 2026-07-23. Site nav, footer, book-promo, and share widgets stripped; inline image captions retained in brackets. Author's words unchanged.]*
