...
author: François Zaninotto (founder & CEO, Marmelab)
publication: Marmelab Blog
...
*[Image: before-after — the IDE's menus and buttons replaced by a single chat input.]*
...
*[Image: SDD.svg — the chained spec → plan → tasks pipeline.]*
...
*[Image: spec-kit-spec — the eight generated Markdown files for a single date-display feature.]*
...
*[Image: waterfall — the classic Waterfall model diagram.]*
...
*[Video: sculpt-3D-demo.mp4 — a demo of the 3D sculpting tool.]*
...
*Capture note (2026-08-31, SDD-primaries hunt): the second of the two "uncaptured primaries behind the SDD critique" that `wiki/overview.md` has listed as open since 2026-08-16 — captured alongside [[eberhardt-putting-spec-kit-through-its-paces]]. Both predate [[ng-spec-driven-development-is-waterfall-in-markdown]] (2026-03) by several months, which reframes the provenance: Ng is downstream of a November-2025 critique wave, not its origin, and the phrase "waterfall in markdown" is close enough to this title to suggest direct lineage. Drew 225 points / 191 comments on Hacker News. Note the article names its own key differences from Eberhardt's: Zaninotto's objection is about **who SDD is for** (it claims to remove developers but requires both a business analyst and a developer to review) and about **non-determinism**, where Eberhardt's is about **measured speed** and the formality of code. Nav/footer/author-bio/CTA stripped; six images and one video noted inline; inline links preserved.*
