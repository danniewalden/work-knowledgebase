...
publication: martinfowler.com — "Exploring Gen AI" series (Thoughtworks)
...
*Capture note (not the author's words): previous article in the series is "TDD inside the agent loop - theater or actual value?" — https://martinfowler.com/articles/exploring-gen-ai/tdd-in-the-agent-loop.html — not yet in `raw/`.*
