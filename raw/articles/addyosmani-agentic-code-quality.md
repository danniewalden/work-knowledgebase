...
*[Image: An AI agent surrounded by quality gates for correctness, security, performance, accessibility, maintainability, cost efficiency, and comprehensibility.]*
...
*[Image: Guillermo Rauch lists the low-stakes situations in which not reading code may be acceptable.]*
...
*[Image: A change is routed to high, gated, or human-decided autonomy according to its risk, evidence, and track record.]*
...
*[Image: A software factory loop from intent through implementation, verification, production, and monitoring.]*
