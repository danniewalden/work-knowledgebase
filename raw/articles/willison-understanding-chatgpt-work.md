...
*[Image: ChatGPT app header with a Chat and a Work tab]*
...
*[Image: Screenshot of a website homepage titled "Pelicans in her piety" — "AN ICONOGRAPHIC CENSUS · GREATER LONDON", with a photograph of Grinling Gibbons's reredos at St Mary Abchurch and a statistics strip reading "28 FIXED SITES", "4 COLLECTIONS", "3 OPEN LEADS", "2 KNOWN LOSSES".]*
...
(A pelican in her piety is a fascinating piece of [medieval Christian imagery](https://devonchurchland.co.uk/blog/pelican-in-her-piety/) - once you know about them you'll find them all over the place.)
...
Captured from the full-content Atom feed at simonwillison.net/atom/everything/; HTML entities decoded and markup converted to Markdown. Section anchors in the bullet list of features were links to headings within the same page and are rendered here as plain text.
