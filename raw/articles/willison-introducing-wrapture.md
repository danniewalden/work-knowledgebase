...
*Blogmark linking to [Graham Dumpleton, "Introducing wrapture"](https://grahamdumpleton.me/posts/2026/08/introducing-wrapture/). Posted 31st August 2026 at 11:59 pm. Tags: graham-dumpleton, monkey-patching, python, testing, pytest, observability, ai-assisted-programming, agentic-engineering, opentelemetry.*

**[Introducing wrapture](https://grahamdumpleton.me/posts/2026/08/introducing-wrapture/)**. New from Graham Dumpleton (of [wrapt](https://pypi.org/project/wrapt/), mod_wsgi, and New Relic's Python agent fame), who describes Wrapture as taking the monkeypatching ideas from wrapt and extending them to apply to testing and tracing at the same time.
