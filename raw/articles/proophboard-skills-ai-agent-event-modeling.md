---
source_url: https://github.com/proophboard/skills
title: "prooph board AI Agent Skills"
author: proophboard
publication: GitHub
...
For detailed installation instructions, see SKILLS.md.
...
For detailed contribution guidelines — including how to structure a skill, add screenshots, and test locally — see CONTRIBUTING.md.
...
1. **Develop your skill** following the skill package structure above
...
ai-agents, event-modeling, ai-tools, spec-driven-development

### Repository metadata (as of retrieval)

- Stars: 3 · Forks: 2 · Watchers: 1 · 51 commits
- Latest release: 2026_06_05 (Jun 5, 2026); 4 releases total
- Languages: JavaScript 52.7%, CSS 47.3%
- Project site: https://skills.prooph-board.com/
