...
*[Image: Anatomy of a loop: define a goal, act, evaluate against a strong check, and feed the result back.]*
...
*[Image: The four kinds of loops: turn-based, goal-based, time-based, and proactive.]*
...
*[Image: Goal syntax split into a command, a verifiable condition, and a bound.]*
...
*[Image: Loop syntax, supported time intervals, and the lifecycle through seven-day expiry.]*
...
*[Image: A maker agent drafts the change and an independent checker verifies it.]*
...
*[Image: Parallel agent runs isolated in separate Git worktrees.]*
...
*[Image: A loop supplies the heartbeat while a goal supplies the hands that solve the work.]*
...
*[Image: A written contribution rule becomes an enforceable triage stopping condition.]*
...
*[Image: A guide to when work is safe to loop and when a human should hold the reins.]*
...
*[Image: A comparison of goal, loop, and schedule across triggers, persistence, and best uses.]*
