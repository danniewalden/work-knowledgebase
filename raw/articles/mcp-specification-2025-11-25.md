...
author: Model Context Protocol project (Anthropic, et al.)
...
The detailed specification covers: Architecture, Base Protocol, Server Features, Client Features, and Contributing.

---

*Capture note: this is the specification overview page. Sub-pages (Architecture, Base Protocol, Server/Client Features) were not captured. A newer release candidate, 2026-07-28, was noted as available at capture time (stateless protocol core, Extensions framework, Tasks, MCP Apps, authorization hardening, formal deprecation policy).*
