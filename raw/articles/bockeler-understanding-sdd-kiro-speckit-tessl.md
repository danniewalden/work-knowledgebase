...
*[Image: the sections of the generated Kiro design document.]*
...
*[Image: the spec-kit file topology — one spec spread across many files.]*
...
*[Image: an example Tessl spec reverse-engineered from a JavaScript file.]*
...
*Capture note (2026-08-31, SDD-primaries hunt): the third of the four "uncaptured primaries behind the SDD critique" open in `wiki/overview.md` since 2026-08-16 — this is the "Fowler/Böckeler Kiro analysis" the note refers to. **This is the origin of the spec-first / spec-anchored / spec-as-source taxonomy** that the KB already uses as working vocabulary, and it predates both Eberhardt (2025-11-26) and Zaninotto (2025-11-12) — both of whom cite it — and Ng (2026-03) by five months. The **MDD parallel** in the penultimate section is directly load-bearing for [[model-as-code-vs-model-as-language]] and was not previously in the KB from any source: Böckeler argues spec-as-source may inherit "the downsides of both MDD and LLMs: inflexibility and non-determinism," and notes that MDD's parseable structure bought tool support for writing valid, complete, consistent specs — the thing natural-language specs give up. Retrieved via live Chrome (WebFetch could not reach this URL). Nav/footer/prev-next links stripped; four images noted inline.*
